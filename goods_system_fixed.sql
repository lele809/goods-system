...
-- Records of product
-- ----------------------------
-- 修复INSERT语句，使字段顺序与表结构匹配
INSERT INTO `product` (id, name, spec, unit, initial_stock, price, amount, remaining_quantity, image_url, created_at, updated_at) 
VALUES 
(1, '苹果', '红富士/中号', '斤', 100, 8.50, 850.00, 100, NULL, '2025-08-26 11:21:08', '2025-08-26 11:21:08'),
(2, '香蕉', '进口/大号', '斤', 50, 6.80, 340.00, 50, NULL, '2025-08-26 11:21:08', '2025-08-26 11:21:08'),
(3, '橘子', '本地/小号', '斤', 80, 4.20, 336.00, 80, NULL, '2025-08-26 11:21:08', '2025-08-26 11:21:08');
